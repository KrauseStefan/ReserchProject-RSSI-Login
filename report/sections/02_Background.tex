...
BLE is a fairly new standard and as such not all devices support it yet. However this is outweighed by what is gained from choosing BLE (power saving, no pairing\cite{ref:Power_usage}). 
