...
\begin{itemize}
	\item BLE has low power consumption when set to use the BLE periphal role \cite{ref:Power_usage}, which periphal role is enough for the phone device. In a real life scenario the Bluetooth might need to be turned on for sevreal hours, which makes power consumption an important factor.
